...
- Keep `ruff check`, `ruff format --check`, `ty check`, branch coverage at or above the configured
  floor, the offline test suite, protocol validation, and package build green in CI.
